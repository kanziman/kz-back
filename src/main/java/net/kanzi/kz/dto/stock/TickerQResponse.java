...
public class TickerResponse {
    ...
    @Builder
    public TickerResponse(Long id, LocalDateTime baseDate, String stockCode, String fsType, Float per, Float pbr, Float psr, Float dy, Double value, Long shares, Long volume, Double close) {
        this.id = id;
