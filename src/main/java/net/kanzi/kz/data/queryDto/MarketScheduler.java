...
public class MarketScheduler {
    ...
    public void scheduleTask() throws SQLException {
        // ADR LIST
        List<DailyMarketSummary> adrList = getCountAdrReduce();
        Date firstDate = adrList.get(0).getDate();

        // MARKET LIST >= ADR[0].baseDate
        List<MarketRefine> marketList = em.createNativeQuery(marketSql, MarketRefine.class)
        ...
        // COMPLETE
        upsertMarketList(marketList);
        log.info("ScheduleTask Finished...");
    }

    private void upsertMarketList(List<MarketRefine> marketList) throws SQLException {
    ...
    List<DailyMarketSummary> getCountAdrReduce(){
